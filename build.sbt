...
ThisBuild / scmInfo := Some(
  ScmInfo(
    url("https://github.com/p2m2/ihm-githubio-gcms2isocor"),
    "scm:git@github.com:p2m2/ihm-githubio-gcms2isocor.git"
  )
)
...
lazy val root = (project in file(".")).
  ...
  .settings(
    ...
    Compile / mainClass := Some("fr.inrae.p2m2.webapp.GCMS2IsocorWebappMain"),
