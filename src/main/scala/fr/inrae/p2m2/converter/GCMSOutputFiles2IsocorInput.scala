package fr.inrae.p2m2.converter

import fr.inrae.p2m2.format.GCMS.{HeaderField, HeaderFileField}
import fr.inrae.p2m2.format.GCMS.HeaderField.HeaderField
import fr.inrae.p2m2.format.GCMS
import fr.inrae.p2m2.parser.GCMSParser
